...
export const useFormData = (validator = null, values = {}) => {
  ...
  // returns the state which either has the input values or input values and errors
  // and a function reference called change, to be called when the input changes 
  return [state, change];
};